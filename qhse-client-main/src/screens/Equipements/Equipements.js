...
export const Equipements = () => {
  ...
  const handleUploadFile = async (e) => {
    ...
    value === 0
      ...
      : value === 1
      ? setEditValuesMat({ ...editValuesMat, [e.target.id]: fileName })
      : setEditValuesLog({ ...editValuesLog, [e.target.id]: fileName });
    setLoading(false);
  };
  const submitFormEq = async (e) => {
    ...
    if (Object.keys(equipement).every((x) => equipement[x] !== "")) {
      try {
        await axios.post(
          "http://localhost:5000/api/equipement/createEq",
          equipement
        );
  ...
  const submitFormMat = async (e) => {
    ...
    if (Object.keys(material).every((x) => material[x] !== "")) {
      try {
        await axios.post(
          "http://localhost:5000/api/equipement/createMat",
          material
        );
  ...
  const submitFormLog = async (e) => {
    ...
    if (Object.keys(logistic).every((x) => logistic[x] !== "")) {
      try {
        await axios.post(
          "http://localhost:5000/api/equipement/createLog",
          logistic
        );
  ...
  const editEquips = async () => {
    ...
    if (value === 0) {
      ...
      if (Object.keys(editValues).every((x) => editValues[x] !== "")) {
        try {
          await axios.put(
            "http://localhost:5000/api/equipement/" + editValues._id,
            editValues
          );
      ...
      if (value === 1) {
        ...
        if (Object.keys(editValuesMat).every((x) => editValuesMat[x] !== "")) {
          try {
            await axios.put(
              "http://localhost:5000/api/equipement/" + editValuesMat._id,
              editValuesMat
            );
            setEquips((prevEquips) => {
              const newEquip = prevEquips.map((x) => {
        ...
        if (Object.keys(editValuesLog).every((x) => editValuesLog[x] !== "")) {
          try {
            await axios.put(
              "http://localhost:5000/api/equipement/" + editValuesLog._id,
              editValuesLog
            );
            setEquips((prevEquips) => {
              const newEquip = prevEquips.map((x) => {
  ...
  const deleteEquips = async () => {
    ...
    if (value === 0) {
      try {
        ...
        setClickedEq(0);
        setEquips((prevArray) => {
          const deletedArray = prevArray.filter(
            (x) => x._id !== editValues._id
          );
          return deletedArray;
        });
  ...
  const selectZones =
    zones &&
    zones.map((zone) => (
      <MenuItem key={zone._id} value={zone.code}>
        <Link className="link" to={"/zones/" + zone._id}>
          {zone.code}
        </Link>
      </MenuItem>
    ));
  ...
  const materials =
    materialsFilter !== undefined &&
    materialsFilter.map((x, i) => {
      return (
        <Material
          num={i + 1}
          key={x._id}
  ...
  const logistics =
    logisticsFilter !== undefined &&
    logisticsFilter.map((x, i) => {
      return (
        <Logistic
          num={i + 1}
          key={x._id}
          ...
          <div className=" col-9 col-sm-12 col-md-5 col-lg-6 d-flex b justify-content-center align-items-center row">
            <h1>
              ...
              {value === 0
                ...
                ? "Materiels"
                : "Logistiques"}{" "}
              <small>{equipements.length === 0 && " : Vide"}</small>
            </h1>
            ...
            {logistics.length !== 0 && value === 2 && (
              <table className="table table-striped table-hover">
                ...
                <tbody>{logistics}</tbody>
              </table>
            )}
          </div>
          {clickedEq === 0 ? (
            <div
              className="col-9 col-sm-12 col-md-4 col-lg-3 register-a"
              ...
              <form className="form-group">
                ...
                {value === 0 && (
                  <TextField
                    ...
                    defaultValue="Choisir une zone"
                  >
                    <MenuItem value="Choisir une zone">
                      Choisir une zone
                    </MenuItem>
                    {selectZones}
                  </TextField>
                ...
                <div className="form-control m-2 d-flex align-items-center">
                  {value === 0 ? (
                    <input
                      readOnly={true}
                      className="form-control m-2"
                      value={editValues ? editValues.fiche_technique : ""}
                    ...
                    <input
                      readOnly={true}
                      className="form-control m-2"
                      value={editValuesMat ? editValuesMat.fiche_technique : ""}
                      placeholder="Fiche Technique"
                      ref={fiche_technique}
                    />
                  ) : (
                    <input
                      readOnly={true}
                      className="form-control m-2"
                      value={editValuesLog ? editValuesLog.fiche_technique : ""}
                      placeholder="Fiche Technique"
                      ref={fiche_technique}
                    />
                  )}
                ...
                <div className="form-control m-2 d-flex align-items-center">
                  {value === 0 ? (
                    <input
                      readOnly={true}
                      className="form-control m-2"
                      value={editValues ? editValues.fds : ""}
                      placeholder="FDS"
                      ref={fds}
                    />
                  ) : value === 1 ? (
                    <input
                      readOnly={true}
                      className="form-control m-2"
                      value={editValuesMat ? editValuesMat.fds : ""}
                      placeholder="FDS"
                      ref={fds}
                    />
                  ) : (
                    <input
                      readOnly={true}
                      className="form-control m-2"
                      value={editValuesLog ? editValuesLog.fds : ""}
                      placeholder="FDS"
                      ref={fds}
                    />
                  )}
            ...
            >
              <div className="d-flex justify-content-center m-2">
                <IoMdCloseCircle
                  className="fournisseur-close"
                  color="red"
                  size={30}
                  onClick={() => setClickedEq(0) && setEditValues()}
                />
              </div>
              <h1 className="text-prime pb-5">
                Equipement numéro: {clickedEq}
              </h1>
              <form className="form-group">
                <input
                  className="form-control m-2"
                ...
                <div className="form-control m-2 d-flex align-items-center">
                  <input
                    ...
                    className="form-control m-2"
                    value={
                      editValues ? editValues.fiche_technique.slice(13) : ""
                    }
                    placeholder="Fiche Technique"
                    ref={fiche_technique}
                  />
                ...
                <div className="form-control m-2 d-flex align-items-center">
                  <input
                    readOnly={true}
                    className="form-control m-2"
                    value={editValues ? editValues.fds.slice(13) : ""}
                    placeholder="FDS"
                    ref={fds}
                  />
                  <label variant="contained" component="label">
                ...
                <div className="d-flex justify-content-end m-2">
                  <div className="d-flex justify-content-center align-items-center">
                    <Button className="bg-prime mx-2" onClick={editEquips}>
                      Modifier
                    </Button>
                    <Button className="bg-danger" onClick={deleteEquips}>
                      Supprimer
                    </Button>
                  </div>
                </div>
            ...
            >
              <div className="d-flex justify-content-center m-2">
                <IoMdCloseCircle
                  ...
                  color="red"
                  size={30}
                  onClick={() => setClickedEq(0) && setEditValuesMat()}
                />
              </div>
              <h1 className="text-prime pb-5">
                Equipement numéro: {clickedEq}
              ...
              <form className="form-group">
                ...
                <div className="form-control m-2 d-flex align-items-center">
                  <input
                    ...
                    value={
                      editValuesMat
                        ? editValuesMat.fiche_technique.slice(13)
                        : ""
                    }
                    placeholder="Fiche Technique"
                    ref={fiche_technique}
                ...
                <div className="form-control m-2 d-flex align-items-center">
                  <input
                    readOnly={true}
                    className="form-control m-2"
                    value={editValuesMat ? editValuesMat.fds.slice(13) : ""}
                    placeholder="FDS"
                    ref={fds}
                  />
                  <label variant="contained" component="label">
            ...
            >
              <div className="d-flex justify-content-center m-2">
                <IoMdCloseCircle
                  ...
                  color="red"
                  size={30}
                  onClick={() => setClickedEq(0) && setEditValuesLog()}
                />
              </div>
              <h1 className="text-prime pb-5">
                Equipement numéro: {clickedEq}
              ...
              <form className="form-group">
                ...
                <div className="form-control m-2 d-flex align-items-center">
                  <input
                    ...
                    value={
                      editValuesLog
                        ? editValuesLog.fiche_technique.slice(13)
                        : ""
                    }
                    placeholder="Fiche Technique"
                    ref={fiche_technique}
                ...
                <div className="form-control m-2 d-flex align-items-center">
                  <input
                    readOnly={true}
                    className="form-control m-2"
                    value={editValuesLog ? editValuesLog.fds.slice(13) : ""}
                    placeholder="FDS"
                    ref={fds}
                  />
                  <label variant="contained" component="label">
