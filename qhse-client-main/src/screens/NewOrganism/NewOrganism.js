...
export default function NewOrganism() {
  ...
  const userOrganism = async (e) => {
    ...
    const organism = {
      ...
      site_num: site_num.current.value,
      creation_date: creation_date.current.value,
      domaines: domaines.current.value,
      tel: value,
        ...
        <div className="row">
          <div className=" col-9 col-sm-12 col-md-5 col-lg-5 d-flex b justify-content-center align-items-center row">
            ...
            <h1 className="text-prime">
              Améliorez votre Efficacité et Productivité
            </h1>
          </div>
          <div
            className="col-9 col-sm-12 col-md-4 col-lg-4 register-a"
          ...
          >
            ...
            <form className="form-group ">
              ...
              <div className="d-flex justify-content-end m-2">
                <Button className="bg-prime" onClick={userOrganism}>
                  Enregister
                </Button>
              </div>
            </form>
