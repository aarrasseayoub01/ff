...
export default function Products() {
  ...
  sortList.creation_date &&
    ...
    (isIncreasing
      ...
      : prods.sort(
          (b, a) => new Date(a.creation_date) - new Date(b.creation_date)
        ));
  sortList.energie &&
    prods &&
    (isIncreasing
  ...
  const products =
    prods !== undefined &&
    prods.map((x, index) => {
      return <Product key={x._id} prod={x} count={index + 1} />;
    });
        ...
        switch (variable) {
          case "energie":
            if (x.energie > 1000) {
              ...
              return (
                variableRange[0] * 10 <= x.energie &&
                variableRange[1] * 10 >= x.energie
              );
            }
          case "proteine":
            if (x.proteine > 1000) {
              ...
              return (
                variableRange[0] * 10 <= x.proteine &&
                variableRange[1] * 10 >= x.proteine
              );
            }
          case "carbs":
            if (x.carbs > 1000) {
              ...
              return (
                variableRange[0] * 10 <= x.carbs &&
                variableRange[1] * 10 >= x.carbs
              );
            }
          case "lipide":
            if (x.lipide > 1000) {
              ...
              return (
                variableRange[0] * 10 <= x.lipide &&
                variableRange[1] * 10 >= x.lipide
              );
            }
        }
      });
            ...
            <div className="d-flex flex-column justify-content-center p-3 border filter">
              ...
              <div className="d-flex justify-content-evenly align-items-center">
                ...
                <TextField
                  ...
                  id="demo-select-small"
                  value={
                    variableRange[1] < 100 ? variableRange[1] * 10 : "+1000"
                  }
                  InputLabelProps={{ shrink: true }}
                />
              </div>
              ...
              <div className="d-flex justify-content-center align-items-center">
                <Button className="border text-black" onClick={validateFilter}>
                  Valider
                </Button>
              </div>
            </div>
        ...
        <div className="row g-1">
          {prods ? (
            ...
            <>
              <Skeleton
                animation="wave"
                className="col-md-6 col-lg-4 col-xl-3 mx-3"
                variant="rectangular"
                width={275}
                height={150}
              />
