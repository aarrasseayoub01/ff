...
const Zones = () => {
  ...
  const handleUploadFile = async (e, type) => {
    ...
    if (type === "zone") {
      ...
      setBatiment({
        ...batiment,
        flux: { ...zone.flux, [e.target.id]: fileName },
      });
    }
    setLoading(false);
  };
  ...
  const saveZone = async () => {
    ...
    try {
      const id = ObjectId();
      if (
        Object.keys(zone).every((x) => zone[x] !== "" && zone[x].length !== 0)
      ) {
  ...
  const saveBatiment = async () => {
    ...
    try {
      const id = ObjectId();
      if (
        Object.keys(batiment).every(
          (x) => batiment[x] !== "" && batiment[x].length !== 0
        )
      ) {
        setBatiment({ ...batiment, _id: id.toString() });
        await axios.post(
          "http://localhost:5000/api/zone/createBatiment",
          batiment
        );
  ...
  useEffect(() => {
    const fetchPersons = async () => {
      ...
      const result = res.data.filter(
        (person) => person.zone === "" || person.zone === undefined
      );
      setPersons(result);
    };
    fetchPersons();
  ...
  const workZones =
    ...
    zones.map((x, i) => {
      return (
        <Zone num={i + 1} key={x._id} id={x._id} zone={x} persons={persons1} />
      );
    });
  const workBatiments =
    batiments !== undefined &&
      ...
      {value === 0 ? (
        <div className="container">
                      ...
                      {selected.map((value) => {
                        ...
                        return (
                          <Chip
                            key={value}
                            label={
                              persons[allIds.indexOf(value)].nom +
                              " " +
                              persons[allIds.indexOf(value)].prenom
                            }
                          />
                        );
                      })}
              ...
              <div className="d-flex align-items-center col-12 col-sm-6 col-md-4 col-lg-4">
                ...
                <label variant="contained" component="label">
                  <input
                    ...
                    type="file"
                    id="mp"
                    onChange={(e) => handleUploadFile(e, "zone")}
                  />
                  <BiUpload
          ...
          <div className="m-3 d-flex justify-content-center">
            <Button className="btn btn-success" onClick={saveZone}>
              Enregistrer
            </Button>
          </div>
        ...
        <div className="container">
          <div className="text-center">
            <h1 className="text-center">Nouveau Bâtiment</h1>
          </div>
          <div className="container d-flex justify-content-center">
            <Box
              className="row d-flex justify-content-center"
            ...
            >
              ...
              <FormControl>
                ...
                <Select
                  ...
                  error={
                    blurredBatiment &&
                    blurredBatiment.equipe &&
                    batiment.equipe.length === 0
                  }
                  label="Equipe *"
              ...
              <div className="d-flex align-items-center col-12 col-sm-6 col-md-4 col-lg-4">
                ...
                <label variant="contained" component="label">
                  <input
                    ...
                    type="file"
                    id="mp"
                    onChange={(e) => handleUploadFile(e, "batiment")}
                  />
                  <BiUpload
                    style={{ cursor: "pointer", marginLeft: "10px" }}
                    size={20}
          ...
          <div className="d-flex justify-content-center m-3">
            <Button className="btn btn-success" onClick={saveBatiment}>
              Enregistrer
            </Button>
          </div>
          <div className="text-center">
